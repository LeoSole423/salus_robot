...
docker compose run --rm ros2 bash -lc '
  ...
  smoke_start_launch localization "ros2 launch salus_localization localization_sim.launch.py"
  ...
  smoke_run localization "python3 /ros2_ws/tools/smoke_localization_sim.py"
'
