...
Fuentes históricas: `73434bc`, `492dd13`, `b7b0a57`, `9477dd1`, `0208160` y
`d235d77` de
`ROS2_SALUS`.
...
la recuperación de tensión no lo cancela. Manual, E-stop o una pausa detienen
el movimiento sin borrar el latch ni reanudar automáticamente; la cancelación
explícita termina la misión.
...
un poll tardío. `BatteryMissionGuard` tiene precedencia sobre el fallback de
SOC y activa la misma política de salida estructurada que el retorno manual.
La decisión de mantener el retorno enclavado está documentada en ADR 0003.
