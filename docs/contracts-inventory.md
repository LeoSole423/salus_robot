...
| Mediciones de vehículo | `MeasurementMetadata`, `TractionMeasurement`, `SteeringMeasurement` | contrato canónico, adaptador legacy de lectura y conversión cinemática calibrada incorporados; quedan perfiles, odometría canónica, fuentes directas y validación física según ADR 0008 |
