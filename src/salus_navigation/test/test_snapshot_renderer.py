...
def test_renderer_returns_png_and_layers_for_complete_scene() -> None:
    ...
    scene = SnapshotScene(
        ...
        footprint=Polyline("base_footprint", ((1.0, 0.3), (1.0, -0.3), (-0.1, -0.3)), (0, 255, 0), closed=True),
        stop_zone=Polyline("base_footprint", ((1.5, 0.5), (1.5, -0.5), (-0.2, -0.5)), (0, 0, 255), closed=True),
        scan=Polyline("base_footprint", ((1.0, 0.0),), (0, 80, 255)),
        plan=Polyline("map", ((-3.0, 0.0), (3.0, 0.0)), (64, 255, 64)),
        transforms=(
            Transform2D("base_footprint", "odom", 0.0, 0.0, 0.0),
