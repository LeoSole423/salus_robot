"""Launch the structured patrol/HOME coordinator for the real stack."""
...
def generate_launch_description() -> LaunchDescription:
    """Expose the existing patrol API with wall-clock ROS time."""
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable="patrol_mission_coordinator",
            name="patrol_mission_coordinator",
            output="screen",
            parameters=[{
