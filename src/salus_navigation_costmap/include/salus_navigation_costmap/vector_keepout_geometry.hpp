...
// Values here preserve the legacy OccupancyGrid scale (0..100).
struct CostProfile { double halo_radius_m{1.5}; unsigned char halo_edge_cost{12}; unsigned char halo_min_cost{1}; unsigned char core_cost{100}; };
