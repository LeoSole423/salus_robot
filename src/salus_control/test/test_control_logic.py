...
def test_cmd_vel_conversion_api_has_no_ignored_angular_rate_limit() -> None:
    assert "max_abs_angular_z" not in inspect.signature(command_from_cmd_vel).parameters
