...
from salus_control.control_logic import DesiredCommand
from salus_control.sim_gazebo_backend import SimGazeboBackend
...
class UartTransportBackend:
    def __init__(
        ...
        *,
        ...
        from salus_control.rpy_esp32_comms.transport import CommsClient
